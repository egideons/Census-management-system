...
$attrib = $_GET['attrib'];
$arr = array();
$subcity = ["Aninri", "Awgu", "Ezeagu", "Igbo-etiti", "Igboeze north", "Igboeze south", "Isi uzo", "Nkanu east", "Nkanu west", "Nsukka", "Oji river", "Udenu", "Udi", "Uzo uwani"];
