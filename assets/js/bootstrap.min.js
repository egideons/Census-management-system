      ...
      return (
        ...
        (i.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var d = function () {
              ...
              var n = t._hoversubstate;
              (t._hoversubstate = null),
        ...
        (i._enter = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            e(n.getTipElement()).hasClass("show") || "show" === n._hoversubstate
              ? (n._hoversubstate = "show")
              : (clearTimeout(n._timeout),
                (n._hoversubstate = "show"),
                n.config.delay && n.config.delay.show
                  ? (n._timeout = setTimeout(function () {
                      "show" === n._hoversubstate && n.show();
                    }, n.config.delay.show))
                  : n.show());
        }),
        (i._leave = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            n._isWithActiveTrigger() ||
              (clearTimeout(n._timeout),
              (n._hoversubstate = "out"),
              n.config.delay && n.config.delay.hide
                ? (n._timeout = setTimeout(function () {
                    "out" === n._hoversubstate && n.hide();
                  }, n.config.delay.hide))
                : n.hide());
        }),
