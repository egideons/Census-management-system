...
(function (h) {
      ...
      error: function (b, c) {
        ...
        -1 === h.inArray(!0, d) &&
          ("parsererror" == c
            ...
            : 4 === b.readysubstate && K(a, 0, "Ajax error", 7));
        C(a, !1);
      },
    };
    a.oAjaxData = b;
  ...
  function za(a) {
    if (a.oFeatures.bsubstateSave && !a.bDestroying) {
      var b = {
        time: +new Date(),
      ...
      s(a, "aosubstateSaveParams", "substateSaveParams", [a, b]);
      a.oSavedsubstate = b;
      a.fnsubstateSaveCallback.call(a.oInstance, a, b);
    }
  }
  function Lb(a, b, c) {
    var d,
      ...
      b = function (b) {
        if (b && b.time) {
          var i = s(a, "aosubstateLoadParams", "substateLoadParams", [a, g]);
          if (
            -1 === h.inArray(!1, i) &&
            ((i = a.isubstateDuration),
            !(0 < i && b.time < +new Date() - 1e3 * i) &&
              !(b.columns && f.length !== b.columns.length))
          ) {
            a.oLoadedsubstate = h.extend(!0, {}, g);
            b.start !== k &&
            ...
            s(a, "aosubstateLoaded", "substateLoaded", [a, g]);
          }
        }
        c();
      };
    if (a.oFeatures.bsubstateSave) {
      var g = a.fnsubstateLoadCallback.call(a.oInstance, a, b);
      g !== k && b(g);
    } else c();
  }
  function Aa(a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          F(o, g, [
            ...
            "bSortCellsTop",
            "iTabIndex",
            "fnsubstateLoadCallback",
            "fnsubstateSaveCallback",
            "renderer",
            "searchDelay",
            "rowId",
            ["iCookieDuration", "isubstateDuration"],
          ...
          z(o, "aosubstateSaveParams", g.fnsubstateSaveParams, "user");
          z(o, "aosubstateLoadParams", g.fnsubstateLoadParams, "user");
          z(o, "aosubstateLoaded", g.fnsubstateLoaded, "user");
          ...
          g.bsubstateSave
            ? ((U.bsubstateSave = !0),
              z(o, "aoDrawCallback", za, "substate_save"),
              Lb(o, g, e))
            : e();
        }
      });
  ...
  p("substate()", function () {
    return this.context.length ? this.context[0].oSavedsubstate : null;
  });
  p("substate.clear()", function () {
    return this.iterator("table", function (a) {
      a.fnsubstateSaveCallback.call(a.oInstance, a, {});
    });
  });
  p("substate.loaded()", function () {
    return this.context.length ? this.context[0].oLoadedsubstate : null;
  });
  p("substate.save()", function () {
    return this.iterator("table", function (a) {
      za(a);
    });
  });
  ...
  m.defaults = {
    ...
    fnServerData: null,
    fnServerParams: null,
    fnsubstateLoadCallback: function (a) {
      try {
        return JSON.parse(
          (-1 === a.isubstateDuration ? sessionStorage : localStorage).getItem(
            "DataTables_" + a.sInstance + "_" + location.pathname
          )
        );
      } catch (b) {}
    },
    fnsubstateLoadParams: null,
    fnsubstateLoaded: null,
    fnsubstateSaveCallback: function (a, b) {
      try {
        (-1 === a.isubstateDuration ? sessionStorage : localStorage).setItem(
          "DataTables_" + a.sInstance + "_" + location.pathname,
          JSON.stringify(b)
        );
      } catch (c) {}
    },
    fnsubstateSaveParams: null,
    isubstateDuration: 7200,
    iDeferLoading: null,
    iDisplayLength: 10,
    iDisplayStart: 0,
    iTabIndex: 0,
  ...
  m.models.oSettings = {
    ...
    aoPreDrawCallback: [],
    aoInitComplete: [],
    aosubstateSaveParams: [],
    aosubstateLoadParams: [],
    aosubstateLoaded: [],
    sTableId: "",
    nTable: null,
    nTHead: null,
  ...
  h.extend(m.ext.oJUIClasses, m.ext.classes, {
    ...
    sPageButtonActive: "ui-substate-disabled",
    sPageButtonDisabled: "ui-substate-disabled",
    sPaging:
